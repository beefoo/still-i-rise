...
parser.add_argument('-in', dest="INPUT_FILE", default="clips/lines/line_000_1.wav", help="Path to input audio file file")
parser.add_argument('-pitch', dest="OUTPUT_PITCH_FILE", default="data/temp.Pitch", help="Path to output pitch data file")
parser.add_argument('-pulse', dest="OUTPUT_PULSE_FILE", default="data/temp.PointProcess", help="Path to output pulse data file")
parser.add_argument('-ts', dest="TIME_STEP", default="0.01", help="Time step in seconds")
parser.add_argument('-p0', dest="PITCH_FLOOR", default="80", help="Pitch floor in Hz")
...
parser.add_argument('-st', dest="SILENCE_THRESHOLD", default="0.03", help="Silence threshold")
...
parser.add_argument('-p1', dest="PITCH_CEILING", default="180", help="Pitch ceiling in Hz")
