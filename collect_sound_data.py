...
parser.add_argument('-p0', dest="PITCH_FLOOR", default="75", help="Pitch floor in Hz")
...
parser.add_argument('-st', dest="SILENCE_THRESHOLD", default="0.02", help="Silence threshold")
...
parser.add_argument('-p1', dest="PITCH_CEILING", default="275", help="Pitch ceiling in Hz")
